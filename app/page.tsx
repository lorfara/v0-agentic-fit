...
export default function Home() {
  ...
  const [formData, setFormData] = useState<ProjectFormData>({
    name: 'Alden - Personal Dietician Agent',
    persona: 'Fitness Enthusiasts, Older Adults Focused on Wellness, people with health conditions like PCOS, Special-Diet Users (vegan, gluten-free, lactose-intolerant, cultural diets), Weight-Management Seekers. These users want personalized guidance but face barriers: generic diet apps that don\'t adapt to their lifestyle, expensive human dieticians who aren\'t always accessible, and lack of real-time support and accountability.',
    what: 'People struggle to eat healthier not because they lack information, but because they lack personalized guidance, real-time support, and consistent accountability. Current diet apps are generic, rigid, and disconnected from users\' daily lives, while human dieticians are expensive and not always accessible. A personal dietician AI agent fills this gap by offering adaptive, individualized nutrition support that fits a user\'s lifestyle, preferences, and habits — helping them turn healthy intentions into sustainable daily action.',
    agentic: 'Nutrition requires continuous personalization, context awareness, and adaptability — things fixed rules cannot handle. An agentic system reasons about: User\'s current dietary preferences, health conditions, and lifestyle constraints. Daily context (mood, available time, social events, travel). Progress patterns and learning from past choices. Real-time adjustments based on feedback. An AI agent can understand nuance, adjust to real-life changes, learn from user behavior, and provide supportive, human-like guidance that\'s far more effective than predefined rules or static meal plans.',
    moat: 'A generic model or ChatGPT provides one-size-fits-all nutrition advice. Whereas, Alden is built specifically for personal nutrition, learns the user\'s unique habits and preferences over time, integrates with their real-life data and context, adapts to daily changes and constraints, and provides consistent, long-term coaching — things broad, one-size-fits-all chatbots simply aren\'t designed to do. The personal relationship and ongoing learning create a sustainable competitive advantage.'
  })
