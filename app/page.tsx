...
export default function Home() {
  ...
  const [formData, setFormData] = useState<ProjectFormData>({
    name: 'PM.OS: The Product Manager Operating System',
    persona: 'Product Managers who: Spend 8-15+ hours/week writing PRDs and documentation. Juggle discovery, stakeholder alignment, roadmap planning, and delivery. Struggle with context switching across tools (Notion, Jira, Slack, Miro, Confluence). Need to translate strategy into clear execution artifacts. Work with engineering, design, and business stakeholders with competing priorities. Want structured thinking support without losing ownership. Operate in fast-paced environments with incomplete information.',
    what: 'Product Managers spend a significant portion of their time writing PRDs, aligning stakeholders, and translating strategy into execution. But: Context is scattered across tools (Notion, Jira, Slack, docs). PRDs are often rewritten from scratch. Assumptions go undocumented. Trade-offs are made without structured reasoning. Product knowledge is lost when team members leave. Strategy and execution frequently drift apart. PRDs are not just documents — they are structured thinking artifacts. Yet most PMs rely on templates, ad-hoc notes, or generic AI tools that generate text without understanding evolving context.',
    agentic: 'Product management is dynamic decision-making under uncertainty. Every product initiative requires continuous reasoning across: Market insights → problem framing → opportunity sizing. User research → hypotheses → experiments. Strategy → roadmap → backlog → delivery. Stakeholder feedback → trade-offs → iteration. Rule-based systems fail because each product context is unique, trade-offs depend on shifting constraints, PRDs are reasoning artifacts not templates, and stakeholder dynamics constantly change. Agentic AI can: Conduct structured discovery interviews with PMs. Challenge assumptions and surface risks. Coordinate specialized agents (discovery, strategy, PRD drafting, metrics, stakeholder comms). Maintain persistent product memory across initiatives.',
    moat: '1. Product Workflow-Native Architecture — Built specifically around PM workflows (discovery → validation → roadmap → delivery), not generic text generation. 2. Persistent Product Memory Layer — Maintains product context, decisions, trade-offs, assumptions over time (not stateless chat). 3. Multi-Agent Specialization — Dedicated agents for problem framing, competitive analysis, PRD drafting, KPI design, stakeholder messaging, and risk assessment. 4. Structured Thinking Frameworks Embedded — Jobs-to-be-Done, RICE, Opportunity Scoring built into the reasoning process.'
  })
