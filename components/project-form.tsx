      ...
      <div className="py-5 px-6 border-b border-[var(--border)] flex items-center gap-3.5">
        ...
        <div>
          ...
          <div className="text-sm text-[var(--muted)] mt-0.5">
            All fields are optional &mdash; fill in as much as you know
          </div>
        </div>
      </div>
      ...
      <div className="p-6">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-5 mb-5">
          ...
          <div className="flex flex-col gap-1">
            <label className="text-[14px] font-bold text-[var(--text)]" htmlFor="f-name">
              Project Name
            </label>
            <span className="text-[13px] text-[var(--muted)] mb-1">
          ...
          {/* Target Persona */}
          <div className="flex flex-col gap-1">
            <label className="text-[14px] font-bold text-[var(--text)]" htmlFor="f-persona">
              Target Persona
            </label>
            <span className="text-[13px] text-[var(--muted)] mb-1">
              Who is this for?
          ...
          <div className="flex flex-col gap-1 md:col-span-2">
            <label className="text-[14px] font-bold text-[var(--text)]" htmlFor="f-what">
              What does it do &mdash; and why does it matter?
            </label>
            <span className="text-[13px] text-[var(--muted)] mb-1">
            ...
            <textarea
              ...
              className="py-3 px-4 border-2 border-[var(--border)] rounded-[var(--radius-sm)] font-sans text-[15px] text-[var(--text)] bg-white transition-all outline-none leading-normal resize-y min-h-[100px] form-textarea placeholder:text-[#9ca3af]"
            />
          </div>

          {/* Why is it Agentic */}
          <div className="flex flex-col gap-1">
            <label className="text-[14px] font-bold text-[var(--text)]" htmlFor="f-agentic">
              Why is it Agentic?
            </label>
            <span className="text-[13px] text-[var(--muted)] mb-1">
          ...
          {/* MOAT */}
          <div className="flex flex-col gap-1">
            <label className="text-[14px] font-bold text-[var(--text)]" htmlFor="f-moat">
              MOAT
            </label>
            <span className="text-[13px] text-[var(--muted)] mb-1">
        ...
        <div className="flex items-center justify-between flex-wrap gap-3 pt-2">
          <span className="text-sm text-[var(--muted)]">
            Fields are optional &mdash; fill in as much as you know
          </span>
          <button
            onClick={onSubmit}
            disabled={isLoading}
            className="inline-flex items-center justify-center gap-2 py-3 px-5 rounded-[var(--radius-sm)] font-display text-[15px] font-extrabold cursor-pointer border-2 border-transparent transition-all leading-none whitespace-nowrap bg-[var(--orange)] text-white border-[var(--orange)] hover:bg-[var(--orange-hover)] hover:border-[var(--orange-hover)] hover:-translate-y-0.5 disabled:opacity-45 disabled:cursor-not-allowed disabled:transform-none"
